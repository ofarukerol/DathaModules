                ...
                <PageToolbar
                    ...
                    actions={
                        <div className="flex items-center gap-2.5">
                            <div className="flex items-center bg-white/10 border border-white/15 p-1 rounded-xl gap-1">
                                <button
                                    onClick={() => setActiveTab('purchase')}
                                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTab === 'purchase'
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTab === 'sale'
                                        ? 'bg-white text-[#663259] shadow-sm'
                                        : 'text-white/70 hover:text-white hover:bg-white/10'
                                        }`}
                                >
